...
sql_query = generate_sql_query(schedule_type=refresh_interval, catalog=catalog, schema=schema, table_name=table_name)
sql_query

# COMMAND ----------

inference_df = spark.sql(sqlQuery=sql_query)
